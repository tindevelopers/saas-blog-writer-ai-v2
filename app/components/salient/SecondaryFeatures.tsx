...
const features: Array<Feature> = [
  {
    ...
    summary: 'Plan and schedule your content with an intuitive calendar.',
    description:
  ...
  },
  {
    ...
    summary:
      'Work together with your team seamlessly on every piece of content.',
    description:
      'Invite team members, assign roles, leave comments, and collaborate in real-time. Perfect for content teams of any size.',
    image: '/images/screenshots/inventory.png',
    icon: function CollaborationIcon() {
      return (
        <>
          <path
            opacity=".5"
  ...
  },
  {
    ...
    summary:
      'Access hundreds of pre-built templates for every type of blog post.',
    description:
      'Choose from our extensive library of templates for how-to guides, listicles, reviews, and more. Customize to match your brand.',
    image: '/images/screenshots/contacts.png',
    icon: function TemplatesIcon() {
      return (
        <>
          <path
            opacity=".5"
...
export function SecondaryFeatures() {
  return (
    <section
      ...
      aria-label="Features for streamlining your workflow"
