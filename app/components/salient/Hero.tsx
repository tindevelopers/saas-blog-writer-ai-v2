    ...
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative">powered by AI</span>
        </span>{' '}
      ...
      <div className="mt-36 lg:mt-44">
        ...
        <div className="mt-8 flex items-center justify-center gap-x-8 sm:gap-x-12">
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm text-slate-600 mt-1">Blog Posts Generated</p>
          </div>
          <div className="h-12 w-px bg-slate-300" />
          <div className="flex flex-col items-center">
            <p className="text-4xl font-bold text-blue-600">10K+</p>
            <p className="text-sm text-slate-600 mt-1">Active Writers</p>
          </div>
          <div className="h-12 w-px bg-slate-300" />
          <div className="flex flex-col items-center">
